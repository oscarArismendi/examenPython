import os
from commons.menus import main_menu,genres_menu,actors_menu,formats_menu,movies_menu#,report_menu
...
from business.movies import new_movie,edit_movie,show_movies
